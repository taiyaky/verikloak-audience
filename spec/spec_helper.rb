...
if ENV['SIMPLECOV']
  begin
    ...
    SimpleCov.start do
      ...
      add_filter %r{^/spec/}
      # Fail CI when line coverage regresses below this floor. Not enforced
      # locally so focused runs (e.g. a single spec file) stay usable.
...
begin
  ...
  warn "[spec_helper] failed to load verikloak/audience: #{e.message}"
end
